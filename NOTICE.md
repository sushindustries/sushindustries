...
| `buymeacoffee-button.svg` (in `media/`, not `logos/` - it names a funding link, not a dependency) | Buy Me a Coffee | Official brand asset, used unmodified to link to the funding page in FUNDING.yml |
