import type {
	ReferencePage as ReferencePageRow,
	ReferenceProvider as ReferenceProviderRow,
} from "@sushindustries/db/schema";
import type { GraphQLResolveInfo } from "graphql";
import type {
	ElementShard as ElementShardModel,
	ShapedElement,
...
> = ResolversObject<{
	...
	kind?: Resolver<
		Maybe<ResolversTypes["DocumentKind"]>,
		ParentType,
		ContextType
	>;
	members?: Resolver<
		Array<ResolversTypes["CollectionMember"]>,
		ParentType,
		ContextType
	>;
...
export type CollectionMemberResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["CollectionMember"] = ResolversParentTypes["CollectionMember"],
> = ResolversObject<{
...
export type DocumentPageResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["DocumentPage"] = ResolversParentTypes["DocumentPage"],
> = ResolversObject<{
...
> = ResolversObject<{
	...
	shards?: Resolver<
		Array<ResolversTypes["ElementShard"]>,
		ParentType,
		ContextType
	>;
	...
	tokens?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
	variants?: Resolver<
		Array<ResolversTypes["ElementVariant"]>,
		ParentType,
		ContextType
	>;
	version?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type ElementShardResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ElementShard"] = ResolversParentTypes["ElementShard"],
> = ResolversObject<{
...
export type ElementVariantResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ElementVariant"] = ResolversParentTypes["ElementVariant"],
> = ResolversObject<{
...
> = ResolversObject<{
	...
	changedSince?: Resolver<
		Array<ResolversTypes["Document"]>,
		ParentType,
		ContextType,
		RequireFields<QueryChangedSinceArgs, "shas">
	>;
	collection?: Resolver<
	...
	>;
	documentPage?: Resolver<
		ResolversTypes["DocumentPage"],
		ParentType,
		ContextType,
		RequireFields<QueryDocumentPageArgs, "limit" | "offset">
	>;
	documents?: Resolver<
		Array<ResolversTypes["Document"]>,
		ParentType,
		ContextType,
		RequireFields<QueryDocumentsArgs, "limit" | "offset">
	>;
	element?: Resolver<
		Maybe<ResolversTypes["Element"]>,
		ParentType,
		ContextType,
		RequireFields<QueryElementArgs, "name">
	>;
	elementShard?: Resolver<
		Maybe<ResolversTypes["ElementShard"]>,
		ParentType,
		ContextType,
		RequireFields<QueryElementShardArgs, "path">
	>;
	elements?: Resolver<
		Array<ResolversTypes["Element"]>,
		ParentType,
		ContextType,
		Partial<QueryElementsArgs>
	>;
	findReference?: Resolver<
		Array<ResolversTypes["ReferencePage"]>,
		ParentType,
		ContextType,
		RequireFields<QueryFindReferenceArgs, "limit" | "query">
	>;
	providers?: Resolver<
		Array<ResolversTypes["ReferenceProvider"]>,
		ParentType,
		ContextType
	>;
	repository?: Resolver<
	...
	>;
	search?: Resolver<
		Array<ResolversTypes["SearchHit"]>,
		ParentType,
		ContextType,
		RequireFields<QuerySearchArgs, "limit" | "query">
	>;
...
export type ReferencePageResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ReferencePage"] = ResolversParentTypes["ReferencePage"],
> = ResolversObject<{
...
export type ReferenceProviderResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ReferenceProvider"] = ResolversParentTypes["ReferenceProvider"],
> = ResolversObject<{
	...
	pages?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<ReferenceProviderPagesArgs, "limit">
	>;
...
> = ResolversObject<{
	commits?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<RepositoryCommitsArgs, "limit">
	>;
	...
	pullRequests?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<RepositoryPullRequestsArgs, "limit">
	>;
	pushedAt?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	stars?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
	url?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	workflowRuns?: Resolver<
		Array<ResolversTypes["WorkflowRun"]>,
		ParentType,
		ContextType,
		RequireFields<RepositoryWorkflowRunsArgs, "limit">
	>;
}>;

export type SearchHitResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["SearchHit"] = ResolversParentTypes["SearchHit"],
> = ResolversObject<{
...
export type ShardedProviderResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["ShardedProvider"] = ResolversParentTypes["ShardedProvider"],
> = ResolversObject<{
	entries?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
	provider?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type ShardingResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["Sharding"] = ResolversParentTypes["Sharding"],
> = ResolversObject<{
	byProvider?: Resolver<
		Array<ResolversTypes["ShardedProvider"]>,
		ParentType,
		ContextType
	>;
	entries?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
...
export type TotalsResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes["Totals"] = ResolversParentTypes["Totals"],
> = ResolversObject<{
	documents?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
	providers?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
