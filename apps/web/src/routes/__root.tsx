...
export const Route = createRootRouteWithContext<RouterContext>()({
	...
	head: () => ({
		meta: [
			...
			// The defaults: the full social set, which a leaf's own seo() call
			// overrides tag by tag rather than half-and-half.
			...seo().meta,
		],
		// Order matters: atoms defines the tokens that prose.css reads.
		links: [
			{ rel: "icon", href: SITE.image, type: "image/png" },
			{ rel: "apple-touch-icon", href: SITE.image },
