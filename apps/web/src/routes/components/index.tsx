...
export const Route = createFileRoute("/components/")({
	...
	head: ({ loaderData }) => ({
		...
		// The machine-readable half: this page is a collection of components,
		// not one of them - the same relationship every other CollectionPage on
		// the web declares around its ItemList.
		scripts: loaderData
			? [ldScript(componentsCollectionPage(loaderData.items))]
			: [],
	}),
	loader: () => {
