...
| calendar | `M4 7.5A1.5 1.5 0 0 1 5.5 6h13A1.5 1.5 0 0 1 20 7.5v11a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 18.5z` `M4 10.5h16` `M8.5 3.5v4` `M15.5 3.5v4` | A month, with the header band ruled off and two rings above it. Beside the clock it is unmistakably a date rather than a duration, which is the only distinction the two have to carry. |
