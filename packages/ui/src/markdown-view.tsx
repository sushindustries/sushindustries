...
export interface MarkdownViewProps {
	...
	source: string;
	/**
	 * Custom `::start:name` blocks (written inside an HTML comment) this
	 * document may use, keyed by name. This is how a Markdown file reaches a
	 * live React component without this package having to know what that
	 * component is.
	 */
