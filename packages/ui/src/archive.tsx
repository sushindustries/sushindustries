...
export function Archive({
	...
	/*
	 * Clamped to the tags that actually narrow something: sorted by count
	 * first, so the cut falls after the useful ones. Unclamped, a library this
	 * size offers seventy chips before a single card - a wall the reader has
	 * to scroll past rather than a filter they reach for.
	 */
	const MAX_TAGS = 16;
